...
lr = 0.001
bnn = BNN(env.get_model_input_dim(), env.get_model_output_dim(), hidden_dim=32, n_pred=10, num_replay_samples=100, lr=lr, kl_weight = 1 / lr ** 2 * 0.000001, epochs=10, device=device)
